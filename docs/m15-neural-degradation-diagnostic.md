...
M15D_NEXT                   OPTIMIZATION OBJECTIVE / TARGET FACTORIZATION AUDIT
M15E_ADAM_CONTROL           COMPLETE / TRAIN FIT IMPROVED
M15E_POLICY_GATE            FAIL (533 BPS / 1500 REQUIRED)
M15E_VALUE_GATE             FAIL (0 BPS / 500 REQUIRED)
M15E_DIAGNOSIS              SOURCE-LEVEL GENERALIZATION GAP
M15E_CANDIDATE              NOT AUTHORIZED
M15_NEXT                    TARGET FACTORIZATION / DATA COVERAGE AUDIT
```
