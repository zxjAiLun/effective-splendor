...
type Reviewer = { id:string; display_name:string; description:string; competitive_status:"champion"|"experimental"|"rejected"; result_kind:"root_determinization"|"neural_ismcts"|"policy_recommendation"; is_default:boolean; available_metrics:string[]; estimated_cost:string };
