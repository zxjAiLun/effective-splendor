...
4. Real provenance preflight executes full production preflight_m32a() and enforces root metadata, 64-char semantic hashes, D2 baseline SHA, parameter count, and fail-closed directory.
...
def test_sidecar_validator_integrity_and_leakage_detection():
    ...
    valid_payload = {
        ...
        "exporter_file_sha256": "e" * 64,
        "ordered_256_replay_bundle_digest": "r" * 64,
...
def test_real_provenance_preflight_for_m32a():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        sidecar_payload = {
            "milestone": "M32A",
            "feature_contract_version": FEATURE_CONTRACT_VERSION,
            "exporter_file_sha256": "a" * 64,
            "ordered_256_replay_bundle_digest": "b" * 64,
        ...
        assert res["exporter_file_sha256"] == "a" * 64
        assert res["ordered_256_replay_bundle_digest"] == "b" * 64
